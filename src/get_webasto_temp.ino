...
const uint32_t NTC_R0 = 50000UL;     // Номинальное сопротивление NTC при 25°C (в Омах), UL для unsigned long literal
const uint16_t NTC_B = 3950;          // B-коэффициент NTC (из даташита терморезистора)
const uint32_t NTC_SERIES_RESISTOR = 200000UL; // Сопротивление последовательного резистора (в Омах)
